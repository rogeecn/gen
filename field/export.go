...
var banColumnRaw Option = func(col clause.Column) clause.Column {
	col.Raw = false
	return col
}
...
func NewRelation(fieldName, fieldType string, relations ...Relation) *Relation {
	return &Relation{
		fieldName:      fieldName,
		fieldPath:      fieldName,
		fieldType:      fieldType,
...
func NewRelationWithType(relationship RelationshipType, fieldName, fieldType string, relations ...Relation) *Relation {
	return &Relation{
...
func NewRelationWithModel(relationship RelationshipType, fieldName, fieldType string, fieldModel interface{}, relations ...Relation) *Relation {
	return &Relation{
		relationship: relationship,
		fieldName:    fieldName,
		fieldType:    fieldType,
