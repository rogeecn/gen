...
// Between ...
func (field Float64) Between(left, right float64) Expr {
	return field.between([]interface{}{left, right})
}

// NotBetween ...
func (field Float64) NotBetween(left, right float64) Expr {
...
// Between ...
func (field Float32) Between(left, right float32) Expr {
	return field.between([]interface{}{left, right})
}

// NotBetween ...
func (field Float32) NotBetween(left, right float32) Expr {
	return Not(field.Between(left, right))
}
